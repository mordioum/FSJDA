...
public class FsjdaApp {

    private static final Logger log = LoggerFactory.getLogger(FsjdaApp.class);

    private final Environment env;

    public FsjdaApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(FsjdaApp.class);
